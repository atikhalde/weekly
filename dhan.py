...
class DhanClient:
    ...
    def daily_candles(self, security_id: str, exchange_segment: str,
        ...
        Requested in yearly chunks and stitched together. Asking for 5 years in
        one call can come back short or empty depending on how Dhan caps the
        window, which made every symbol look like it had too little history.
        Chunking keeps each request small and is resilient to that cap.
        """
        frames, cursor = [], from_date
