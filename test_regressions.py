...
def _report_trades():
    ...
    def mk(sym, e, q, sl, ex, why, pnl, r):
        t = PaperTrade(symbol=sym, week="2026-07-27", entry_date="2026-07-27",
                       entry_time="09:50", entry=e, qty=q, invested=e * q,
...
def test_excel_report_has_required_sheets_and_columns(tmp_path):
    ...
    for required in ("Symbol", "Entry Date", "In", "Entry", "Qty", "Stop Loss",
                     "26W Level", "Exit Date", "Out", "Exit", "P&L (Rs)", "R"):
